...
def OpenFlow(self, payload, valid_ports=None):
    if valid_ports is None:
        valid_ports = [6653]

    if self is None or is_of_port(self.dport, valid_ports) or is_of_port(self.sport, valid_ports):
...
def is_of_port(port, valid_ports):
